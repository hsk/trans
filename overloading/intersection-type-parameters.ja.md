...
## 1はじめに
  ...
  対照的に、 Girard-Reynolds システムF \[<a name="r7"></a>[7](#7), <a name="r25"></a>[25](#25)\] では、型の中に汎用的な量指定子を使用することができます。
  システムF に基づく言語では、 foo を割り当てることができます。
  たとえば、次のように型付けします
...
<!-- page 2 -->
    ...
    3
    Kfoury and Tiuryn have indeed also proved undecidability of typeability for any
