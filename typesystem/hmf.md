...
- HMF is a conservative extension: every program that is welltyped in Hindley-Milner, is also a well-typed HMF program and type annotations are never required for such programs.
